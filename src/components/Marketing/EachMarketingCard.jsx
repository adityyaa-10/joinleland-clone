const EachMarketingCard = () => {
  return (
    <a
      href="/coach/lola-agabalogun"
      className="relative mx-2 flex flex-col items-center justify-between rounded-xl border border-[#E5E5E5] bg-white transition-all duration-150 hover:-translate-y-2 hover:shadow-lg"
    >
      <div className="flex h-52 w-full flex-col items-center border-b border-[#E5E5E5] p-5 text-center">
        <div className="relative mb-4 size-20">
          <img
            ...
            decoding="async"
            data-nimg="fill"
            className="absolute inset-0 h-full w-full rounded-full object-cover text-transparent"
            sizes="80px"
        ...
        <div className="flex items-center">
          <div className="relative size-10">
            <img
              ...
              decoding="async"
              data-nimg="fill"
              className="absolute inset-0 size-10 h-full w-full rounded object-cover text-transparent"
              src="https://images.unsplash.com/photo-1499714608240-22fc6ad53fb2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=76&q=80"
            />
          </div>
          <div className="pl-3">

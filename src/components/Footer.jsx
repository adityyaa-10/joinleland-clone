      ...
      <div className="mx-auto grid max-w-screen-xl grid-cols-12 gap-3">
        <div className="col-span-12 mb-8 lg:col-span-3">
          ...
          <div className="mb-9 flex text-white">
            ...
            >
              ...
              >
                <path
                  fill="#FFFFFF"
                  d="M22 12.061C22 6.505 17.523 2 12 2S2 6.505 2 12.061c0 5.022 3.657 9.184 8.438 9.939v-7.03h-2.54V12.06h2.54V9.845c0-2.522 1.492-3.915 3.777-3.915 1.093 0 2.238.197 2.238.197v2.476h-1.26c-1.243 0-1.63.775-1.63 1.572v1.886h2.773l-.443 2.908h-2.33V22c4.78-.755 8.437-4.917 8.437-9.939Z"
                  vectorEffect="non-scaling-stroke"
                ></path>
              </svg>
            </a>
          ...
          <p className="text-sm text-white/70">
            © Leland 2024. All rights reserved.
          </p>
        </div>
        <div className="col-span-12 mb-8 lg:col-span-3">
          ...
          <ul>
            <li className="mb-1">
              <a
                ...
                href="https://www.joinleland.com/signup"
              >
                Get started
              </a>
            </li>
            <li className="mb-1">
              <a
                className="text-lg text-white/60 lg:hover:underline"
                href="https://www.joinleland.com/login"
              >
                Log in
              </a>
            </li>
        ...
        <div className="col-span-12 mb-8 lg:col-span-3">
          ...
          <ul>
            ...
            <li className="mb-1">
              <a
                className="text-lg text-white/60 lg:hover:underline"
                href="/library/management-consulting"
              >
            ...
            <li className="mb-1">
              <a
                className="text-lg text-white/60 lg:hover:underline"
                href="/library/product-management"
              >
                Product Management
              </a>
            </li>
        ...
        <div className="col-span-12 mb-8 lg:col-span-3">
          ...
          <ul>
            <li className="mb-1">
              <a
                href="https://jobs.polymer.co/leland"
                target="_blank"
                rel="noreferrer"
                className="text-lg text-white/60 lg:hover:underline"
              >

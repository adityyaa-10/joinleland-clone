const SignupForm = () => {
  return (
    <div class="grid gap-3">
      <button
        type="button"
        class="shadow-border text-leland-gray-dark flex w-full cursor-pointer items-center justify-center space-x-2 rounded-lg border border-[#e5e7eb] bg-white p-3 text-base font-medium leading-tight shadow-transparent hover:bg-[#f5f5f5] disabled:bg-white sm:whitespace-nowrap"
      ...
      <div class="relative flex w-full items-center justify-center">
        ...
        <span class="absolute left-1/2 -translate-x-1/2 bg-white px-2 text-lg text-[#707070]">
          or
        </span>
      </div>
      <form class="grid gap-3">
          ...
          <div class="flex-1 lg:mr-3">
            <div class="space-y-3">
              <div class="flex items-center overflow-hidden rounded-lg border border-[#e5e7eb] transition duration-100 focus-within:border-[#9B9B9B]">
                <input
                  class="block w-full bg-white p-4 shadow-none outline-none outline-0 ring-0 placeholder:text-gray-400"
                  type="text"
        ...
        <button
          type="submit"
          class="shadow-border inline-flex cursor-pointer items-center justify-center space-x-2 rounded-lg border border-[#15B078] bg-[#15B078] p-3 text-base font-medium leading-tight text-white shadow-transparent hover:border-[#4fbd95] hover:bg-[#4fbd95] disabled:bg-[#15B078] sm:whitespace-nowrap"
